...
async function generateSalesData(config = {}) {
  ...
  defaultStartDate.setMonth(defaultEndDate.getMonth() - 3); // Default to last 3 months
  ...
  const {
    ...
    avgReceiptsPerDay = 15,
    maxItemsPerReceipt = 4
  } = config;
  ...
  // OPRAVA ZDE: Cesta musí být v ` (zpětných apostrofech)

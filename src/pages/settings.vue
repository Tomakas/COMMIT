            ...
            <div v-if="item.id === 'look-and-feel'">
              <v-card-text class="text-left">
                ...
                <v-btn-toggle v-model="mode" color="primary" mandatory rounded="lg">
                  ...
                  <v-btn value="system" icon="mdi-laptop"></v-btn>
                </v-btn-toggle>
                ...
                <v-btn-toggle v-model="navMenuLayout" color="primary" mandatory rounded="lg">
                  <v-btn value="left" icon="mdi-dock-left"></v-btn>
                  <v-btn value="top" icon="mdi-dock-top"></v-btn>
                </v-btn-toggle>
                ...
                <v-btn-toggle v-model="menuStyle" color="primary" mandatory rounded="lg">
                  <v-btn value="full" icon="mdi-format-list-text"></v-btn>
                  <v-btn value="condensed" icon="mdi-dots-grid"></v-btn>
                </v-btn-toggle>
...
// Lokální stav pro Mode zůstává
const mode = ref('system');

// Vypočtené vlastnosti (computed properties) pro propojení s Pinia store
// Nahrazují původní lokální ref() proměnné

// Propojí 'left'/'top' s appStore.navInAppBar (false/true)
